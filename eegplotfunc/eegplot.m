...
function events = eegplot(data, varargin); % p1,p2,p3,p4,p5,p6,p7,p8,p9)
...
try, icadefs;
	DEFAULT_FIG_COLOR = [1 1 1]; %BACKCOLOR;
	BUTTON_COLOR = [1 1 1]; %GUIBUTTONCOLOR;
catch
